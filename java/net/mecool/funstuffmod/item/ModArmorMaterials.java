...
public enum ModArmorMaterials implements ArmorMaterial {
    URANIUM("uranium",26, new int[]{10,10,10,10}, 25,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 5f,0.5f,() -> Ingredient.of(ModItems.URANIUM.get()));
    ...
    public String getName() {
        return funstuffmod.MOD_ID + ":" + this.name;
    }
