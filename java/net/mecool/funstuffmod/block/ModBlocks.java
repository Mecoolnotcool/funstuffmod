...
import net.mecool.funstuffmod.block.custom.RefineryStationBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> REFINERY_STATION = registerBlock("refinery_station",
            () -> new RefineryStationBlock(BlockBehaviour.Properties.copy(Blocks.COBBLESTONE).noOcclusion()));
