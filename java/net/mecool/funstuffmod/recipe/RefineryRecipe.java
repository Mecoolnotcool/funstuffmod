...
public class RefineryRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<RefineryRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(funstuffmod.MOD_ID, "refining");

        @Override
        public RefineryRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new RefineryRecipe(inputs, output, pRecipeId);
        }

        @Override
        public @Nullable RefineryRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, RefineryRecipe pRecipe) {
